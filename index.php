...
<head>
    ...
    <title>CREATIVITY&SCRAPYART Home Page</title>
...
<section class="home" id="home">
    ...
    <div class="content">
        <h3>The Intersection of Traditional <span>Artistry</span> and <span> Innovation</span> </h3>
        <p>Creativity finds new avenues of expression in scrapyart, where discarded materials are transformed into captivating artworks, showcasing the boundless imagination and resourcefulness of artists.</p>
        <a href="creativity.html" class="btn">Buy Now</a>
    </div>
...
<section class="categories" id="categories">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="image/cre48.png" alt="">
            <h3>Ports</h3>
            <p>Upto 45% Off</p>
            <a href="port.html" class="btn">Buy Now</a>
        </div>

        <div class="box">
            <img src="image/cre2.png" alt="">
            <h3>Plastic</h3>
            <p>Upto 45% Off</p>
            <a href="plastic.html" class="btn">Buy Now</a>
        </div>

        <div class="box">
            <img src="image/scr14.png" alt="">
            <h3>Scrap wood</h3>
            <p>Upto 45% Off</p>
            <a href="wood.html" class="btn">Buy Now</a>
        </div>

        <div class="box">
            <img src="image/scr46.png" alt="">
            <h3>Scrap iron</h3>
            <p>Upto 45% Off</p>
            <a href="iron.html" class="btn">Buy Now</a>
        </div>
